...
summonTypes = ['soldier','soldier','soldier','soldier','soldier','soldier','soldier','soldier','soldier','soldier','soldier','soldier','soldier','soldier','paladin']
def summonTroops():
...
loop:
    ...
    #    self.say(enemy.type)
    if(len(items)>0 and self.now()<35):
        pickUpNearestItem(items)
    else: 
        if(enemyattack and enemyattack.type!='munchkin' and enemyattack.type!='thrower' and enemyattack.type!='scout' and self.now()<45):     
            attack(enemyattack)
        else:
            self.shield()
